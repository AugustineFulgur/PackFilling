...
DRIVER_GET_TARGET="" #获取爆破页面的脚本
DRIVER_BEFORE_SUBMIT_VALUE="" #提交数据前的处理
DRIVER_SUBMIT_VALUE="xpath-modules" #替代提交数据的脚本
DRIVER_SUBMIT_ENTER="xpath-modules" #替代发起提交的脚本
...
DRIVER_IDENTIFY_VALUE="xpath-modules" #代替提交验证码的脚本
